...
import com.wavemaker.tests.api.builder.SqlServerDBObjectsBuilder;
...
public class SQLServerWithBlobTests extends BaseTest {
    ...
    @Test(groups = {GroupNameConstants.RUNTIME, GroupNameConstants.DATABASE, GroupNameConstants.SQL_SERVER, GroupNameConstants.INSERT}, description = "Verifies if insertion is successful with blob table")
    ...
    @Test(groups = {GroupNameConstants.RUNTIME, GroupNameConstants.DATABASE, GroupNameConstants.SQL_SERVER, GroupNameConstants.EXPORT}, description = "Verifies if export data is successful with blob table")
    public void verifySqlServerExportBlobData() {
        databaseBlobVerification.verifyExportedBlobData("CSV");
    }

    @Test(enabled = false, groups = {GroupNameConstants.RUNTIME, GroupNameConstants.DATABASE, GroupNameConstants.SQL_SERVER, GroupNameConstants.UPDATE}, description = "Verifies if Updation is successful with blob table")
    ...
    @Test(groups = {GroupNameConstants.RUNTIME, GroupNameConstants.DATABASE, GroupNameConstants.SQL_SERVER, GroupNameConstants.DELETE}, description = "Verifies if deletion is successful with blob table")
