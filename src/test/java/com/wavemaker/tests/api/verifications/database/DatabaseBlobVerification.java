package com.wavemaker.tests.api.verifications.database;
...
import com.wavemaker.tests.api.client.DatabaseRunTimeControllerClient;
import com.wavemaker.tests.api.rest.models.RestResponse;
import com.wavemaker.tests.api.runtime.OracleWithBlobTests;
...
public class DatabaseBlobVerification {
    ...
    public DatabaseBlobVerification(final String appUrl, final String dbName, final String tableName, final Class tableClass) {
        dbRunTimeClient = new DatabaseRunTimeControllerClient(appUrl);
        this.dbName = dbName;
    ...
    public <T> int verifyInsertAndGetBlobData(final T t, final String pkId) {
        ...
        List<T> blobDataAfterInsert = getBlobData(dbName, tableName, tableClass);
        ...
        logger.info("Data insertion with blob column is Successful with response {}", blobDataAfterInsert.toString());

        return countAfterInsert;
    }

    public void verifyExportedBlobData(final String exportType) {
        exportData(dbName, tableName, exportType);
    }
