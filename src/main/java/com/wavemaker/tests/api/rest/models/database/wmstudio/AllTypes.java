...
package com.wavemaker.tests.api.rest.models.database.wmstudio;
...
public class AllTypes{
    ...
    public void setTimeColumn(final LocalDateTime timeColumn) {
    ...
    public void setBooleanColumn(final String booleanColumn) {
