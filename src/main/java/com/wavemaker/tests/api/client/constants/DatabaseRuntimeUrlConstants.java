package com.wavemaker.tests.api.client.constants;
...
public class DatabaseRuntimeUrlConstants {
    ...
    private static final String DB_RUNTIME_COMMON_URL = "/services/:dbName/:tableName";
    ...
    //Runtime urls
    public static final String ALL_RECORDS_URL = "/services/:dbName/:tableName";
    public static final String EXPORT_URL = DB_RUNTIME_COMMON_URL + "/export/:exportType";
    public static final String RECORDS_BY_QUERY_STRING_URL = DB_RUNTIME_COMMON_URL + "?q=:queryString";
    public static final String RECORDS_COUNT_URL = DB_RUNTIME_COMMON_URL + "/count";
    public static final String RECORDS_COUNT_BY_QUERY_STRING_URL = DB_RUNTIME_COMMON_URL + "/count?q=:queryString";
    public static final String RECORD_BY_UNIQUE_KEY_URL = DB_RUNTIME_COMMON_URL + "/:columnName/:columnValue";
    public static final String RECORD_BY_PK_COLUMN_URL = DB_RUNTIME_COMMON_URL + "/:pkColumnValue";
    public static final String RECORD_BY_RELATED_COLUMN_URL = DB_RUNTIME_COMMON_URL + "/:parentTableColumnValue/:relatedObjectName";
    public static final String RECORD_BY_PAGE_SIZE_SORT_URL = DB_RUNTIME_COMMON_URL + "?q=:queryString&" +
            "page=:pageNumber&size=:pageSize&sort=:sortColumn";
    //School DB run time Urls
    public static final String RECORDS_COMPOSITE_KEY_URL = DB_RUNTIME_COMMON_URL + "/composite-id?:compositeString";
